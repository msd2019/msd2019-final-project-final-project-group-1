...
```
We see similar results when replicated the random effects model, which doesn't have team specifici intercepts. It is notable that the relative changes in coefficients between our fixexd and random effects regressions are very similar to that of the original paper. Namely, our coefficients for salary and year increase in magnitude with HHI staying almost identical. One thing that was odd was that both our intercept and the original intercept had win percentage as greater than 50%. 
...
TODO: Analyze regression results and compare.
...
TODO: Analyze prediction results.
